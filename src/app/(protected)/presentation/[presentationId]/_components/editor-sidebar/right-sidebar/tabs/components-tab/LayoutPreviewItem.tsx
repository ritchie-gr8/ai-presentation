  ...
  return (
    <button
      ...
      className={cn(
        ...
        "gap-2 p-2 rounded-lg hover:bg-primary-10 transition-all duration-200",
        "text-center w-full hover:scale-105 transform",
        isSelected && "ring-2 ring-blue-500"
      )}
    >
      <div
        className="w-full aspect-[16/9] rounded-md border bg-gray-100
